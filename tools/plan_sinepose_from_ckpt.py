...
from core.projection import project_points_with_steps_numpy


DEFAULT_CKPT = (
    "outputs_unified/bench/paper_mix_2d_3d6d_traj_vs_nontraj_7seed/"
    "eikonal/6d_workspace_sine_surface_pose_traj_on_eikonal_model.pt"
)
DEFAULT_OUTDIR = (
    "outputs_unified/bench/paper_mix_2d_3d6d_traj_vs_nontraj_7seed/"
    "eikonal/sinepose_planning_paper"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Load trained eikonal model for 6D sinepose and run obstacle-aware point-to-point planning."
    )
    ...
    dist_fig = os.path.join(outdir, "6d_workspace_sine_surface_pose_traj_on_eikonal_planning_error_distribution_paper.png")
