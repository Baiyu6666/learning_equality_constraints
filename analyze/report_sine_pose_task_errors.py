...
def main() -> None:
    ...
    p.add_argument(
        "--obstacle-summary",
        default="outputs/bench/paper_mix_2d_3d6d_traj_vs_nontraj_7seed/oncl/sinepose_obstacle_paper/sinepose_planning_summary.json",
    )
    p.add_argument(
        "--waypoints-summary",
        default="outputs/bench/paper_mix_2d_3d6d_traj_vs_nontraj_7seed/oncl/sinepose_waypoints_paper/sinepose_waypoints_summary.json",
    )
    args = p.parse_args()
